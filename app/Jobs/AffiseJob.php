...
class AffiseJob implements ShouldQueue
{
    ...
    {
        // Get api_url of only Affise from tracking_software 
        $data = OfferApi::where('status', 1)->where('tracking_software', 'Affise')->first();
        // Get data from api 
