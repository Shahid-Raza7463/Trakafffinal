    ...
    <div class="container mt-3">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title mt-3">All Payment Frequency</h3>
                <div class="card-tools">
                    <a href="{{ url('admin/paymentfrequency/create') }}" class="btn btn-sm btn-success">
            ...
            <div class="card-body">
                ...
                <!-- Get Bulk Action -->
                <form action="{{ route('paymentfrequency.bulk-action') }}" method="POST" onsubmit="collectSelectedItems()">
                    @csrf
                ...
                <script>
                    $(function() {
                        $('#table').DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: '{{ route('paymentfrequency.index') }}',
                            columns: [{
                                    data: 'select',
                                    name: 'select',
                                    orderable: false,
