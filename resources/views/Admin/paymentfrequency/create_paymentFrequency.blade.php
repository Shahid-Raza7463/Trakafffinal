    ...
    <div class="container mt-3">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title mt-3">Payment Frequency</h3>
            ...
            <div class="form-Container m-3">
                <form action="{{ url('/') }}/admin/paymentfrequency" method="post">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-6 d-flex flex-column  mb-2">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Enter Name"><span
                                style="font-size: 12px;">(Net-30, Net-15, Weekly, Upon Request, etc)</span>
                        </div>
                    </div>
