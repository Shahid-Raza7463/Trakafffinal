    ...
    <div class="container mt-3">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title mt-3">All Payment List</h3>
                <div class="card-tools">
                    <a href="{{ url('admin/paymentmethod/create') }}" class="btn btn-sm btn-success">
            ...
            <div class="card-body">
                ...
                @endif
                <!-- Get Bulk Action -->
                <form action="{{ route('paymentmethod.bulk-action') }}" method="POST" onsubmit="collectSelectedItems()">
                    @csrf
