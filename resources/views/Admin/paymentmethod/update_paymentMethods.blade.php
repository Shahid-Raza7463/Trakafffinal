    ...
    <div class="container mt-3">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title mt-3">Edit Payment List</h3>
            ...
            <div class="form-container m-3">
                <form action="{{ url('/') }}/admin/paymentmethod/{{ $id }}" method="post">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-6 d-flex flex-column  mb-2">
                            <label for="">Name:<span class="required">*</span></label>
                            <input class="form-control" type="text" value="{{ $paymentMethod->name }}" name="name"
                                placeholder="Enter Name"> <span style="font-size: 12px;">(Check, PayPal, Wire, etc)</span>
                        </div>
                    </div>
