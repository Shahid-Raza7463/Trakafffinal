    ...
    <div class="container mt-3">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title mt-3">Network Software</h3>
            ...
            <div class="form-container m-3">
                <form action="{{ url('/') }}/admin/networksoftware" method="post">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-6 d-flex flex-column  mb-2">
                            ...
                            <input class="form-control" type="text" name="name" placeholder="Enter Name"> <span
                                style="font-size: 12px;">Affiliate Tracking Software (HasOffers, Trakaff, Affise,
                                In-house, etc)</span>
                        </div>
                    </div>
