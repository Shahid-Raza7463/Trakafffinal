    ...
    <div class="container mt-3">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title mt-3">Create Networks</h3>
            ...
            <div class="filter-container mx-2">
                <form action="{{ url('/') }}/networks-list" id="network_form" method="post"
                    enctype="multipart/form-data" class="row g-3 form-cont">
                    @csrf
                        ...
                        <div class="row d-flex flex-row flex-wrap">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select choose" name="network_type" aria-label="Default select example">
                                    ...
                                    <option value="1" {{ old('network_type') == '1' ? 'selected' : '' }}>
                                        Affiliate Network
                                    </option>
                                    <option value="2" {{ old('network_type') == '2' ? 'selected' : '' }}>
                                        Affiliate Program
                                    </option>
                                    <option value="3" {{ old('network_type') == '3' ? 'selected' : '' }}>
                                        Advertising
                                    </option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="vertical_id[]" id="countries" class="countries" value="" multiple>
                            ...
                            <div class="container_social d-flex flex-row flex-wrap mb-2" id="social-main-container">
                                <div class="col-md-6" style="width: 502px; margin-left:-11px">
                                ...
                                <div class="col-md-6" style="margin-left: 10px;">
                                    ...
                                    <div class="d-flex" style="width: 498px;">
                                        <input type="text" name="social_link[]" placeholder="Enter Social Link:"
                                            class="form-control p-1 b_link" value="{{ old('social_link[]') }}"
                                            style="width: 454px;">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $("#network_form").submit(function(e) {
                        ...
                        var url = "{{ url('/') }}/admin/networks-list";
