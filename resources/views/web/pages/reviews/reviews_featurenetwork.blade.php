<div class="col-md-7 col-sm-12 border" style="background-color: #f3f3f3;">
    ...
    {{-- Skip the first two reviews becouse 2 review display above section --}}
    @php
        $reviewCount = 0;
    @endphp
    @foreach ($networks_review as $network)
        ...
        <div class="border mt-3 bg-light rounded feature-rvm">
                ...
                <div class="m-review-title">
                    ...
                    <div class="reviews-rating d-flex">
                        ...
                        <h6 class="text-dark text-capitalize"
                            style="color: #3d4852; font-weight: 600; margin-left: 9px;">{{ $network->name }}</h6>
            ...
            <div class="d-flex justify-content-between mx-3 mb-1 mobile-rv">
            ...
            <div class="message">
                @include('web.pages.reviews.replyform')
            </div>

            {{-- implementation of lightbox for review image of review  --}}
            @if ($network->review_img)
                <div>
                    <a href="{{ asset($network->review_img) }}" data-lightbox="review-images{{ $network->review_id }}">
            ...
            {{-- implementation of lightbox for review image of review end hare  --}}
