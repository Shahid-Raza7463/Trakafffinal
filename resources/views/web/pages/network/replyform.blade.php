    ...
    <div class="reply-section" style="display: none;">
        ...
        <div class="reply-input-wrapper">
            ...
            <div class="d-flex gap-1 input-wrapper2">
                ...
                <input type="hidden" name="network_id" value="{{ $review->network_id }}">
        ...
        <div class="d-flex justify-content-end gap-2 mt-2">
            ...
            <button type="submit" class="btn btn-sm bg-primary text-light">Send</button>
        </div>
    </div>
</form>
...
<script>
    $(document).ready(function() {
        ...
        $("#replyform{{ $review->review_id }}").submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success) {
                        $("#replyform{{ $review->review_id }}")[0].reset();
