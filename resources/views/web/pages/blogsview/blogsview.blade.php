...
@section('content')
    ...
    <div class="container mt-4">
        <div class="mx-3">
            <div class="row">
                @include('web.pages.blogsview.blogstext')
    ...
    {{-- Seo Tag adding --}}
@section('seo')
    <title>{{ $seo_meta[8]['name'] }}</title>
    <meta name="title" content="{{ $seo_meta[8]['meta_title'] }}">
    <meta name="description" content="{{ $seo_meta[8]['meta_description'] }}">
    <meta name="keywords" content="{{ $seo_meta[8]['meta_keywords'] }}">
@endsection
@endsection
